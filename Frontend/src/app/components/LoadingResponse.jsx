    ...
    <div className="flex animate-fade-slide">
      <div className="bg-surface border border-line rounded-[10px] p-6 w-full flex flex-col gap-6">
        ...
        <div className="flex items-center gap-4">
          <div className="w-7 h-7 rounded-full border-[2.5px] border-line border-t-blue animate-spin shadow-[0_0_10px_rgba(88,166,255,0.3)] flex-shrink-0" />
          <div>
            <div className="text-[0.9rem] font-semibold text-fg">Generating Solutions</div>
        ...
        <div className="flex flex-col gap-3">
          {[
            ...
            <div key={label} className="flex items-center gap-4">
              <span
                className={`font-mono text-[0.65rem] font-semibold tracking-[0.05em] uppercase w-[68px] text-right flex-shrink-0 ${
                  label === 'Solution 1' ? 'text-amber' :
                  label === 'Solution 2' ? 'text-green'  : 'text-purple'
                }`}
              >
                {label}
              </span>
