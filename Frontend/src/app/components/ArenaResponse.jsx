  ...
  return (
    <div className="flex flex-col gap-6 animate-fade-slide">
        ...
        >
          ...
          <div className="px-4 py-4 border-t border-line bg-[rgba(240,136,62,0.03)] shrink-0">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[0.78rem] leading-relaxed text-fg-muted">{judge.solution_1_feedback}</p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="px-4 py-4 border-t border-line bg-[rgba(63,185,80,0.03)] shrink-0">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[0.78rem] leading-relaxed text-fg-muted">{judge.solution_2_feedback}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div
        ...
        style={{ background: 'linear-gradient(135deg, #1a1428 0%, #161b22 100%)' }}
      >
        {/* Background bloom */}
        <div
          className="absolute top-0 left-0 right-0 h-48 pointer-events-none"
          style={{ background: 'radial-gradient(ellipse at top, rgba(188,140,255,0.1) 0%, transparent 70%)' }}
        />
        ...
        <div className="relative flex justify-center mb-6">
          <div className="flex items-center gap-10 bg-[rgba(255,255,255,0.03)] px-10 py-4 rounded-lg border border-line">
            <div className={`flex flex-col items-center gap-1 transition-transform duration-200 ${winner === 1 ? 'scale-110' : ''}`}>
              <span
