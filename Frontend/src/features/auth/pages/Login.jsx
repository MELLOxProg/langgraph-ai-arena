...
// GitHub SVG path — reused from Navbar
const GH_PATH =
    ...
    >
      ...
      <section className="auth-hero" aria-hidden="true">
        ...
        <div className="auth-hero__quote">
          <blockquote>
            "Precision beats raw power.<br />
            Two models. One judge. One truth."
          </blockquote>
      ...
      <section className="auth-panel" aria-labelledby="login-heading">
        <div className="auth-panel__inner">
          ...
          <div className="auth-header">
            ...
            <p>Sign in to your arena account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} id="login-form" noValidate>
            ...
            <button id="login-submit-btn" className="btn-submit" type="submit">
              Sign in to Arena
            </button>
          </form>
